...
# che ci sono negli altri 3 modelli (sottolineando come questo sia decisamente migliore anche se non ancora perfetto)
# Ultima cosa il livello di riferimento per le covariate relative al ranking è top220 quindi 
# tutti i coefficienti devono essere interpretati di conseguenza
